...
public class SettingsWindow extends JDialog {
    ...
    private JLabel showLineNumbersLabel;
    ...
    public SettingsWindow() {
        ...
        showLineNumbers.setSelected(SettingsController.getShowLineNumbers());
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.add(logLevelLabel, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(logLevelComboBox, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        logDateTimeCheckBox = new JCheckBox();
        logDateTimeCheckBox.setSelected(false);
        logDateTimeCheckBox.setText("");
        panel1.add(logDateTimeCheckBox, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        logDateTimeLabel = new JLabel();
        this.$$$loadLabelText$$$(logDateTimeLabel, this.$$$getMessageFromBundle$$$("i18n", "show.time.in.logs"));
        panel1.add(logDateTimeLabel, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        logFileLabel = new JLabel();
        this.$$$loadLabelText$$$(logFileLabel, this.$$$getMessageFromBundle$$$("i18n", "log.to.file"));
        panel1.add(logFileLabel, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        panel1.add(logFile, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        showLineNumbersLabel = new JLabel();
        this.$$$loadLabelText$$$(showLineNumbersLabel, this.$$$getMessageFromBundle$$$("i18n", "config.show.line.numbers"));
        panel1.add(showLineNumbersLabel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        showLineNumbers = new JCheckBox();
        showLineNumbers.setSelected(true);
        showLineNumbers.setText("");
        panel1.add(showLineNumbers, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        checkBox1 = new JCheckBox();
        checkBox1.setText("CheckBox");
        contentPane.add(checkBox1, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
