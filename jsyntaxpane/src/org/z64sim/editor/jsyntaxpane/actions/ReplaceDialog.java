...
import org.z64sim.editor.jsyntaxpane.components.Markers;
...
/**
 * A Find and Replace Dialog. The dialog will also act as a listener to Document
 * changes so that all highlights are updated if the document is changed.
 *
...
public class ReplaceDialog extends javax.swing.JDialog implements CaretListener, KeyListener, ContainerListener {
    ...
    /**
     * updates the highlights in the document when it is updated. This is called
