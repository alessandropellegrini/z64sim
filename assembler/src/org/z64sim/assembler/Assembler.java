 ...
 */
  ...
  final public Instruction Drivers() throws ParseException {
    Token t;
    try {
      label_9:
      while (true) {
        ...
        while (true) {
          ...
          default:
            ...
            throw new ParseException();
                ...
                {if (true) return new InstructionClass5(t.image, null);}
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case DRIVER:
          ;
          break;
        ...
        error_recover(ex, NEWLINE);
        {if (true) return null;} // otherwise javaCC throws exceptions
  ...
  final public String Label() throws ParseException {
    ...
    try {
      t = jj_consume_token(LABEL);
        ...
        error_recover(ex, NEWLINE);
        {if (true) return "";}  // otherwise javaCC throws exceptions. An empty string is
  ...
  final public OperandRegister Register() throws ParseException {
    Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REG_8:
        t = jj_consume_token(REG_8);
          {if (true) return new OperandRegister( Register.getRegister8( t.image ) , 8 );}
        break;
      case REG_16:
        t = jj_consume_token(REG_16);
          {if (true) return new OperandRegister( Register.getRegister16( t.image ) , 16 );}
        break;
      case REG_32:
        t = jj_consume_token(REG_32);
          {if (true) return new OperandRegister( Register.getRegister32( t.image ) , 32 );}
        break;
      case REG_64:
        t = jj_consume_token(REG_64);
          {if (true) return new OperandRegister( Register.getRegister64( t.image ) , 64 );}
        break;
      default:
        jj_la1[34] = jj_gen;
        jj_consume_token(-1);
  ...
  final public OperandMemory AddressingBIS(int size) throws ParseException {
    ...
    try {
      ...
      jj_consume_token(RBRACE);
            ...
            // Addressing() rule
            {if (true) return new OperandMemory(bs, base_size, idx, scl, -1, size);}
    } catch (ParseException ex) {
        error_recover(ex, NEWLINE);
        {if (true) return null;} // otherwise javaCC throws exceptions
  ...
  final public OperandMemory Addressing(int size) throws ParseException {
    OperandMemory mem;
    long dispLong = 0;
    Token t;
    try {
  ...
  final public Operand FormatE(int size) throws ParseException {
  ...
  final public int FormatK() throws ParseException {
    OperandImmediate imm;
    try {
      imm = ConstantExpression();
          {if (true) return (int)imm.getValue();}
    } catch (ParseException ex) {
        error_recover(ex, NEWLINE);
        {if (true) return -1;} // otherwise javaCC throws exceptions

    }
    throw new Error("Missing return statement in function");
  }

  final public OperandRegister FormatG() throws ParseException {
    OperandRegister reg;
    try {
      reg = Register();
          {if (true) return reg;}
...
/* Both label and direct address */
  final public OperandMemory FormatM(int size) throws ParseException {
    OperandMemory memOp;
    long address;
    String l;
    try {
  ...
  final public Operand FormatB(int size) throws ParseException {
    OperandImmediate imm;
    OperandMemory mem;
    OperandRegister reg;
    Token t;
...
/***************************************************/
  final public OperandImmediate ConstantExpression() throws ParseException {
    long value;
    try {
      jj_consume_token(CONSTANT);
      value = Expression();
          {if (true) return new OperandImmediate(value);}
    } catch (ParseException ex) {
        error_recover(ex, NEWLINE);
        {if (true) return null;} // otherwise javaCC throws exceptions
  ...
  final public long Expression() throws ParseException {
    long value;
    long i;
    try {
      /* ACTUAL RULE */
  ...
  final public long Term() throws ParseException {
    long value;
    long i;
    try {
      value = Primary();
  ...
  final public long Primary() throws ParseException {
    Token t;
    long i;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x1,0x0,0x300000,0x300000,0x0,0x0,0x0,0x17ffe0,0x0,0x200000,0x0,0x0,0x17ffe0,0x0,0x0,0x0,0x17ffe0,0x0,0x0,0x1,0x0,0x0,0x300000,0x7ffe0,0x1e,0x1,0x1f,0x0,0x20001e,0x300000,0x30001e,0x0,0x0,0x0,0x0,0x200000,};
   }
